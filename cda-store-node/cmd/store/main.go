...
func main() {
	...
	receiver := p2p.NewReceiver(p2pHost, ps, kzg, cfg.PublisherAddr, cfg.K, cfg.KPiece, cfg.NumCols, cfg.StoresPerCol, cfg.RowIdx, cfg.ColIdx, cache, broadcaster, cfg.CrashOnFail)
